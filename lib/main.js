...
panel.port.on("wotMessaging", function (data) {
	console.log("Panel said: ", data);
});

panel.port.emit("wotMessaging", {
	message: "constants",
	data: constants
});
...
function changeIcon() {
	console.log("- main.changeIcon");
}

tabs.on("activate", function (tab) {
	console.log("* main/tabs/activate");
	console.log(tab.url);
});
...
PageMod({
	...
	'onAttach': function (worker) {
		...
		console.log("* main/PageMod/onAttach");
...
core.loadratings("yandex.ru", function(r){
	console.log("loadratings DONE");
});