...
wot.api = require("api").api;
wot.url = require("url").url;
wot.prefs = require("prefs").prefs;


wot.core.loadratings = function (hosts, onupdate) {
...
exports.loadratings = wot.core.loadratings;

wot.core.update = function () {
		try {
...
exports.update = wot.core.update;

wot.core.updatetab = function (id) {
		// TODO: fix it
...
exports.updatetab = wot.core.updatetab;

wot.core.geticon = function (data) {
	try {
...
exports.geticon = wot.core.geticon;

wot.core.seticon = function (tab, data) {
	try {
...
exports.seticon = wot.core.seticon;

wot.core.updatetabstate = function (tab, data) {
	try {
		if (tab.selected) {
...
exports.updatetabstate = wot.core.updatetabstate;

wot.core.updatetabwarning = function (tab, data) {
	try {
...
exports.updatetabwarning = wot.core.updatetabwarning;

wot.core.setusermessage = function (data) {
	try {
		this.usermessage = {};
...
exports.setusermessage = wot.core.setusermessage;
...
exports.setuserlevel = function (data) {
	try {
...
exports.processrules = function (url, onmatch) {
