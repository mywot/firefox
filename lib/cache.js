	...
	var cacheresponse = exports.cacheresponse = function(hosts, data, status)
	{
		...
		try {
			...
			$(targets).each(function() {
				var obj = {
					target: hosts[$(this).attr("index") || 0]   // TODO: fix it
				};
				...
				$("application", this).each(function() {           // TODO: fix it
					var name = parseInt($(this).attr("name"), 10);     // TODO: fix it
					...
					if (name >= 0) {
						...
						for (var i = 0; i < attrs.length; ++i) {
							var value = parseInt($(this).attr(attrs[i]), 10);      // TODO: fix it
						...
						if ($(this).attr("excluded")) {    // TODO: fix it
							data.r = -2;
							data.c = -2;
						}
