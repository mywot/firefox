...
var api = {
	info: {
		maxhosts:       100,
		maxparamlength: 4096,
		server:         "api.mywot.com", // production server
		secure:         true,
		updateformat:   4,
	...
	processpending: function () {
		wot.log("- wot.api.processpending");
	...
	processcookies: function (current) {
		wot.log("- wot.api.processcookies");
	...
	showupdatepage: function () {
		wot.log("- wot.api.showupdatepage");
...
//			});
			...
			var url = wot.urls.update + "/" + wot.i18n("lang") + "/" + wot.platform + "/" + wot.version;
...
//				}, onready);
			...
			wot.browser.opentab(wot.urls.settings + "/welcome", onready);
		}
	},

	link: function (hosts, onupdate, retrycount) {
		wot.log("- wot.api.link");
